...
export const TEXT_MAIN_CRYPTED: Record<string, LangTextI> = {
  innovative: {
    ENG: '',
    RUS: '',
    ESP: ''
...
export const TEXT_MAIN: Record<string, LangTextI> = {
  innovative: {
    ...
    RUS: 'Мобильный Удаленный Регистратор - инновационное решение безопасности, разработанное для того, чтобы дать возможность людям записывать видео и аудиозаписи со своего телефона и мгновенно загружать полученные материалы на защищенный сервер. Эта передовая система адаптирована для ситуаций, когда фиксация и сохранение записи событий в реальном времени незаменимы с точки зрения безопасности и доказательств. Независимо от того, столкнулись ли вы с угрозой, стали свидетелем происшествия или просто хотите обеспечить свою безопасность в кризисных ситуациях, МУР предоставляет мгновенный и безопасный способ записи и хранения доказательств без привлечения внимания.',
    ESP: 'Registrador móvil remoto es una solución de seguridad innovadora elaborada para permitir a la gente hacer grabaciones de video e audio desde su teléfono y al mismo tiempo instantáneamente cargar los materiales recibidos en un servidor seguro. Este avanzado sistema es adaptado para las situaciones cuando la captura y retención  de eventos en tiempo real son indispensables con respecto a la seguridad y pruebas. Ya sea que esté enfrentando una amenaza, presenciando un incidente o simplemente buscando garantizar su seguridad en situaciones peligrosas, MUR propociona una forma inmediata y segura  de grabar y almanecer  las pruebas sin llamar la atención en todos los casos.'
  },
  citizen: {
    ...
    ESP: 'Para los ciudadanos que presencian injusticias o personas que a menudo se encuantran en las situaciones peligrosas, MUR da la posibilidad de actuar con rapidez y seguridad.'
  },
  journalists: {
    ...
    ESP: 'Periodistas, detectives privados y personal del servicio de seguridad pueden utilizar el Registrador móvil remoto para reunir pruebas de manera confidencial y registrar eventos sin comprometer su posición o seguridad.'
  },
  adventurers: {
    ...
    RUS: 'Путешественники и исследователи, отправляющиеся в отдаленные или потенциально опасные места, могут полагаться на МУР для документирования встреч и обеспечения безопасного сохранения цифрового следа своего путешествия.',
    ESP: 'Viajeros y exploradores que se dirigen a lugares remotos o potencialmente peligrosos pueden confiar en el Registrador móvil remoto para documentar encuentros y garantizar la conservación segura de la huella digital de su viaje.'
  },
  anyone: {
    ...
    ESP: 'Cualquiera que valore su seguridad personal y la tranquilidad de saber que puede grabar de manera confidencial situaciones que le parezcan inseguras o amenazantes, descubrirá que el Registrador móvil remoto es un instrumento indispensable.'
  },
  ...
  world: {
    ENG: "In a world where uncertainty can lurk around every corner, MSR offers more than just a recording app; it's a commitment to personal safety and protection. However, in our world, financial commitments cannot be shifted onto us. We provide you with 10 MB of free storage, but you have the option to purchase a paid version where you can set the limits you need.",
    RUS: 'В мире, где неопределенность может подстерегать за каждым углом, MSR предлагает не просто приложение для записи, это обязательство личной безопасности и защиты.',
    ESP: 'En un mundo donde la incertidumbre puede acechar en cada esquina, MSR ofrece más que una simple aplicación de grabación; es un compromiso con la seguridad y protección personal. Sin embargo, en nuestro mundo, los compromisos financieros no pueden ser transferidos a nosotros. Te proporcionamos 10 MB de almacenamiento gratuito, pero tienes la opción de comprar una versión de pago donde puedes establecer los límites que necesitas.'
  }
};
